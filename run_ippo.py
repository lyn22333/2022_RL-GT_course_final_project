...
class IPPO_Runner(object):
    ...
    def __init__(self, args, env):
        ...
        self.log_dir = args['log_dir'] + '/IPPO' + '_' + str(self.n_agents)
        # self.log_dir = args['log_dir'] + '/IPPO'
        if self.use_beta:
            self.log_dir += '_Beta'
        ...
        self.policy = Policy(self.args,
                            ...
                            critic_obs_space = self.obs_space,
    ...
    def run(self):
        for iteration in range(self.iterations):
            ...
            # train_total_reward = torch.round(train_total_reward)
    ...
    def warmup(self):
        ...
        obs = np.swapaxes(obs, 0, 1)
        # share_obs = obs
        self.buffer.critic_obs[0] = obs.copy()
